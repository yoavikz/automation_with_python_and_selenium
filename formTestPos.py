...
class Check(unittest.TestCase):    
    ...
    def test_check(self):
        ...
        self.sauce_client.jobs.update_job(self.driver.session_id, passed=True,name="Positive test")    #Input valid values in all fields!
        ...
        self.driver.find_element_by_xpath("(//input[@type='text'])[2]").send_keys("yoavzaltsman@gmail.com")
